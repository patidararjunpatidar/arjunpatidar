...
public class Mini extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDirection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Mini.this,FindActivity.class);
                                    ...
                                    .enqueue(new Callback<FCMResponce>() {
                                        ...
                                        public void onResponse(Call<FCMResponce> call, Response<FCMResponce> response) {
                                            if (response.body().success ==1)
                                                Toast.makeText(Mini.this, "Request sent", Toast.LENGTH_SHORT).show();
                                            else
                                                Toast.makeText(Mini.this, "Failed !", Toast.LENGTH_SHORT).show();
                                        }
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                if (!isDriverFound) {
                    ...
                    Toast.makeText(Mini.this, "" + key, Toast.LENGTH_SHORT).show();
                }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_dashboard) {
            ...
            startActivity(new Intent(Mini.this,ProfileActivity.class));

        } else if (id == R.id.nav_manage ) {

        } else if (id == R.id.truck_list) {
            startActivity(new Intent(Mini.this,ListOnline.class));
